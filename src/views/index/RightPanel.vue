    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <!-- 标题属性 start -->
          <!--    <el-form-item v-if="activeData.__config__.tagIcon==='title'" label="标题">-->
          <!--    <el-input v-model.number="activeData.__config__.labelWidth" type="text" placeholder="请输入标题" />-->
          <!--    </el-form-item>-->
          <!-- 标题属性 end -->
          ...
          <!-- ['el-checkbox-group', 'el-radio-group', 'el-select', 'el-tabs']公有选项添加 -->
          <template v-if="['el-checkbox-group', 'el-radio-group', 'el-select', 'el-tabs'].indexOf(activeData.__config__.tag) > -1">
          ...
          <!--选项样式-->
          <el-form-item v-if="activeData.__config__.optionType !== undefined && activeData.__config__.optionType != 'tabs'" label="选项样式">
